...
Hardware evaluation boards and kits are provided for use in engineering 
development, demonstration, or evaluation purposes only. They are not considered 
by the OpenPSG authors to be finished end-products fit for general consumer use.

All users are expected to have the necessary knowledge and experience to use the 
hardware and software safely and effectively. The OpenPSG authors are not 
responsible for any injuries, damages, or losses resulting from the use of the
